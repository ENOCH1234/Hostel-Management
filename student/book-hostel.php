...
if (isset($_POST['submit'])) {
    ...
    $stmt->execute();
    echo "<script>alert('You have successfully booked an hostel and bed space!');</script>";
}
?>
                ...
                <form method="POST">
                    ...
                    if ($rs) { ?>
                        <div class="alert alert-primary alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                            ...
                            <strong>Info: </strong> You have already booked a hostel! Check your room details <a href="room-details.php"><strong><span style="color:yellow">HERE</span></strong></a>
                        </div>
                    <?php } else {
                    ?>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="ta" id="ta" placeholder="Total Amount here.." class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
