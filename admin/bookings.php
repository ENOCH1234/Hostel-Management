                ...
                <form method="POST">
                    ...
                    if ($rs) { ?>
                        <div class="alert alert-primary alert-dismissible bg-primary text-white border-0 fade show" role="alert">
                            ...
                            <strong>Info: </strong> Student already booked a hostel!
                        </div>
                    <?php } else {
                        echo "";
                    }
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="regno" id="regno" placeholder="Enter matriculation number" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
